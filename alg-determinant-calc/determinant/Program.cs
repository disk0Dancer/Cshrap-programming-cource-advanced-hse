...
namespace determinant
{
        ...
        static int[,] InitMatrix()
    {
        ...
        {
            //случайная матрица
            int lines = 10;//new Random().Next(3, 5);
        ...
        {
            //лаплас
            //int[,] matrix = new int[,] {{6,1,0,0 }, {5,6,1,0}, {0,5,6,1},{0,0,5,6}};
            ...
            //double[,] matrixD = new double[,]{{6,1,0,0 }, {5,6,1,0}, {0,5,6,1},{0,0,5,6}};
            //double[,] matrixD = new double[,]{{1,2 }, {1,2}};
